...
As shown in this website, the best sentiment analysis model (up to 2019)\footnote{The model used: \url{https://arxiv.org/pdf/1906.08237}.} had an accuracy of 96\%, using a self-attention setup. The only preprocessing done was just encoding relative positioning in the vector representation.
